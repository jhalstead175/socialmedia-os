-- =====================================================================
-- 20260608000400_email_campaigns.sql
-- Email Campaigns module: Postgres schema (DDL + RLS + indexes)
-- SoshlOps · Supabase Postgres 17. Apply AFTER the three base migrations.
-- (Canonical source: docs/email-campaigns/03-database-schema.sql)
-- ---------------------------------------------------------------------
...
-- Per-org email settings (CAN-SPAM mailing address, default sender, etc.).
-- Lives on organizations (already RLS-isolated). e.g.
--   { "mailing_address": "...", "default_from_name": "...",
--     "default_reply_to": "...", "double_opt_in": false }
