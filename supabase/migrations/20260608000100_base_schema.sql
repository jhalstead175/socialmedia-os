-- =====================================================================
-- 20260608000100_base_schema.sql
-- SoshlOps base schema (8 tables) — RECOVERED from docs/schema.sql
-- after the Supabase project was deleted 2026-06-08.
-- Faithful reproduction of the original v1 schema. No data is recovered;
-- this rebuilds structure only. Apply to the fresh "SoshlOps" project.
-- =====================================================================
...
create table assets (
  ...
  storage_path text not null unique,   -- {org_id}/{uuid}.{ext}
